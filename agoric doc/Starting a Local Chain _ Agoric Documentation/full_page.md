...
As you're going through this explainer it may be helpful to watch this video walkthrough.
 ...
 [Help us improve this page!](https://github.com/Agoric/documentation/edit/main/main/guides/getting-started/explainer-how-to-start-a-local-chain.md)

Last Updated: 

Pager[Previous pageGetting Started](/guides/getting-started/)[Next pageTakeaway 2: Deploying a Smart Contract](/guides/getting-started/explainer-deploying-a-smart-contact.html)

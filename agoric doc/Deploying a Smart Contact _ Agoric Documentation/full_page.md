...
As you're going through this explainer it may be helpful to watch this video walkthrough.
 ...
 [Help us improve this page!](https://github.com/Agoric/documentation/edit/main/main/guides/getting-started/explainer-deploying-a-smart-contact.md)

Last Updated: 

Pager[Previous pageTakeaway 1: Starting a Local Chain](/guides/getting-started/explainer-how-to-start-a-local-chain.html)[Next pageTakeaway 3: Making an Offer](/guides/getting-started/explainer-how-to-make-an-offer.html)

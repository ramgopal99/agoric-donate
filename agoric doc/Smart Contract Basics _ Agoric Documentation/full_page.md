...
* [$TRACK\_TURNS](https://github.com/Agoric/agoric-sdk/blob/master/docs/env.md#track_turns)
 [Help us improve this page!](https://github.com/Agoric/documentation/edit/main/main/guides/zoe/contract-basics.md)

Last Updated: 

Pager[Previous pageTakeaway 3: Making an Offer](/guides/getting-started/explainer-how-to-make-an-offer.html)[Next pageHello World Smart Contract](/guides/zoe/contract-hello.html)

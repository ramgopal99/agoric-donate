...
3. [Submit transactions to install and deploy the contract](./local-testnet.html).
 [Help us improve this page!](https://github.com/Agoric/documentation/edit/main/main/guides/coreeval/index.md)

Last Updated: 

Pager[Previous pageBuilding Client Dapps](/guides/getting-started/contract-rpc.html)[Next pageWrite Code to Deploy a Contract](/guides/coreeval/proposal.html)

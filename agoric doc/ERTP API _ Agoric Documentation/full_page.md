...
| [DisplayInfo](./ertp-data-types.html#displayinfo) | Specifies how to display a **Brand**'s **Amounts**. |
 ...
 [Help us improve this page!](https://github.com/Agoric/documentation/edit/main/main/reference/ertp-api/index.md)

Last Updated: 

Pager[Previous pageEndo API Reference](https://endojs.github.io/endo/)[Next pageIssuer Object](/reference/ertp-api/issuer.html)

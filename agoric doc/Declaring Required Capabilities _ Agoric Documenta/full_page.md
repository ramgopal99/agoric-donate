...
* **zoe**: the [Zoe service](/reference/zoe-api/zoe.html)
 [Help us improve this page!](https://github.com/Agoric/documentation/edit/main/main/guides/coreeval/permissions.md)

Last Updated: 

Pager[Previous pageWrite Code to Deploy a Contract](/guides/coreeval/proposal.html)[Next pageSubmit Transactions](/guides/coreeval/local-testnet.html)

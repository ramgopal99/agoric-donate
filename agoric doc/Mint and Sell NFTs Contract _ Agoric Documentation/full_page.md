...
The `offerResult` is a record with useful properties such as the `creatorFacet` for the sales contract. You can reuse the `creatorFacet` of this contract to mint more batches of NFTs (e.g. more tickets for a separate show.)
 ...
 [Help us improve this page!](https://github.com/Agoric/documentation/edit/main/main/guides/zoe/contracts/mint-and-sell-nfts.md)

Last Updated: 

Pager[Previous pageMint Payments Contract](/guides/zoe/contracts/mint-payments.html)[Next pageUse Object Contract](/guides/zoe/contracts/use-obj-example.html)

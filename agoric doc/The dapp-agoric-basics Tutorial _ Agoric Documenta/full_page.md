...
Once the transaction has completed, you will notice the tickets in your wallet: ![Screenshot: Tickets in Keplr wallet](/assets/dapp-agoric-basics-005.CfN7RX14.png)
 ...
 [Help us improve this page!](https://github.com/Agoric/documentation/edit/main/main/guides/getting-started/tutorial-dapp-agoric-basics.md)

Last Updated: 

Pager[Previous pageTutorial: Dapp with Agoric](/guides/getting-started/tutorial/)[Next pageTakeaway 1: Sell Concert Tickets Contract Overview](/guides/getting-started/sell-concert-tickets-contract-explainer.html)

...
Restart your app and it should load as before without errors. Now, the app is running with Hardened JS enabled and we're ready to continue.
 ...
 [Help us improve this page!](https://github.com/Agoric/documentation/edit/main/main/guides/getting-started/ui-tutorial/starting.md)

Last Updated: 

Pager[Previous pageUI Tutorial](/guides/getting-started/ui-tutorial/)[Next page2. Agoric Provider](/guides/getting-started/ui-tutorial/agoric-provider.html)

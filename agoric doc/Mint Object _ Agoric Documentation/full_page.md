...
**aMint.mintPayment()** is the only way to create new digital assets. There is no other way.
 ...
 [Help us improve this page!](https://github.com/Agoric/documentation/edit/main/main/reference/ertp-api/mint.md)

Last Updated: 

Pager[Previous pageIssuer Object](/reference/ertp-api/issuer.html)[Next pageBrand Object](/reference/ertp-api/brand.html)

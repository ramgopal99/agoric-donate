...
What is Agoric Orchestration? [​](#what-is-agoric-orchestration)
================================================================
...
Introduction to Orchestration API Flow [​](#introduction-to-orchestration-api-flow)
-----------------------------------------------------------------------------------
...
![](/assets/orchestration-workflow-1.CN3JBV8-.svg)  
 [Help us improve this page!](https://github.com/Agoric/documentation/edit/main/main/guides/orchestration/index.md)

Last Updated: 

Pager[Next pageKey Concepts and APIs](/guides/orchestration/key-concepts.html)

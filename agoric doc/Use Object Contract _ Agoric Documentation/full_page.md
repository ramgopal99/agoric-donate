...
This contract is an example of associating a particular ability with ownership of a non-fungible token (NFT). In this case, ownership of a particular pixel NFT gives the user the ability to color that pixel. Note that the NFT must be escrowed at the time for the coloring to succeed.
 ...
 [Help us improve this page!](https://github.com/Agoric/documentation/edit/main/main/guides/zoe/contracts/use-obj-example.md)

Last Updated: 

Pager[Previous pageMint and Sell NFTs Contract](/guides/zoe/contracts/mint-and-sell-nfts.html)[Next pageAutomatic Refund Contract](/guides/zoe/contracts/automatic-refund.html)

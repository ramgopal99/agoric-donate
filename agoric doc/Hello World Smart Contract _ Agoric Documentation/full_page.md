...
* [$TRACK\_TURNS](https://github.com/Agoric/agoric-sdk/blob/master/docs/env.md#track_turns)
 [Help us improve this page!](https://github.com/Agoric/documentation/edit/main/main/guides/zoe/contract-hello.md)

Last Updated: 

Pager[Previous pageSmart Contract Basics](/guides/zoe/contract-basics.html)[Next pageState Smart Contract](/guides/zoe/contract-state.html)

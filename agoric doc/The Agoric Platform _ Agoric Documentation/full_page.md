...
Tendermint is a consensus engine, defining how blocks are agreed upon and created. Effectively, Tendermint is the lowest level layer that defines the blockchain itself.
 ...
 [Help us improve this page!](https://github.com/Agoric/documentation/edit/main/main/guides/platform/index.md)

Last Updated: 

Pager[Previous pageWhat is Agoric?](/what-is-agoric.html)[Next pageZoe Smart Contract Framework](/guides/zoe/)
